...
@XmlType(name = "RandomArrangement", namespace = "http://morphml.org/networkml/schema", propOrder = {
    "notes",
    "properties",
    "annotation",
    "group",
...
public class RandomArrangement {
    ...
    @XmlElement(name = "population_size", namespace = "http://morphml.org/networkml/schema", required = true)
    protected BigInteger populationSize;
    @XmlElement(name = "spherical_location", namespace = "http://morphml.org/networkml/schema")

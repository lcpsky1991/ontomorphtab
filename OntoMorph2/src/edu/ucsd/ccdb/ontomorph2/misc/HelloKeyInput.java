...
public class HelloKeyInput extends SimpleGame{
	...
	private static final Logger logger = Logger.getLogger(HelloKeyInput.class.getName());
	...
	protected void simpleInitGame() {
		TriMesh square = getTriMesh();
		TriMesh square2 = getTriMesh();
		
		
		square2.setLocalTranslation(new Vector3f(0,0,2));
		
		Node n = new Node();
		n.attachChild(square);
		n.attachChild(square2);
		Node n2 = new Node();
		Node n3 = new Node();
	...
	protected TriMesh getTriMesh() {
		...
		URL sliceLoc = HelloKeyInput.class.getClassLoader().getResource("slice.jpg");
		//get my texturestate
...
//		 point to a URL of my model
		URL model = HelloKeyInput.class.getClassLoader().getResource("neuron.3ds");

...
@XmlType(name = "ConnectivityPattern", namespace = "http://morphml.org/networkml/schema", propOrder = {
    "allToAll",
    "fixedProbability",
    "perCellConnection"
})
public class ConnectivityPattern {
    ...
    @XmlElement(name = "all_to_all", namespace = "http://morphml.org/networkml/schema")
    protected ConnectivityPattern.AllToAll allToAll;
    @XmlElement(name = "fixed_probability", namespace = "http://morphml.org/networkml/schema")
    protected ConnectivityPattern.FixedProbability fixedProbability;
    @XmlElement(name = "per_cell_connection", namespace = "http://morphml.org/networkml/schema")

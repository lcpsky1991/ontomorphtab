...
@XmlType(name = "VariableNamedParameter", namespace = "http://morphml.org/biophysics/schema", propOrder = {
    "group",
    "inhomogeneousValue"
})
public class VariableNamedParameter {
    ...
    @XmlElement(name = "inhomogeneous_value", namespace = "http://morphml.org/biophysics/schema", required = true)

...
public class Population {
    ...
    @XmlElement(name = "cell_type", namespace = "http://morphml.org/networkml/schema", required = true)
    protected String cellType;
    @XmlElement(namespace = "http://morphml.org/networkml/schema")
    protected Instances instances;
    @XmlElement(name = "pop_location", namespace = "http://morphml.org/networkml/schema")

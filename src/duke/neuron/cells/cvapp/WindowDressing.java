...
abstract class WindowDressing {
	...
	public static void drawUpButton(Graphics g, Color c, int x, int y, int w,
			int h) {
		g.setColor(c.darker());
	...
	public static void drawDownButton(Graphics g, Color c, int x, int y, int w,
			int h) {
	...
	public static void drawBoolButton(Graphics g, boolean b, Color c, int x,
			int y, int w, int h) {
		if (b) {

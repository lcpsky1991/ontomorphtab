...
public class Projection {
    ...
    @XmlElement(name = "synapse_props", namespace = "http://morphml.org/networkml/schema", required = true)
    protected List<SynapseProperties> synapseProps;
    @XmlElement(namespace = "http://morphml.org/networkml/schema")
    protected Connections connections;
    @XmlElement(name = "connectivity_pattern", namespace = "http://morphml.org/networkml/schema")
